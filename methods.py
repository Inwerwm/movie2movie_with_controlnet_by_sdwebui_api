...
def create_request_json(color_frame_base64: str, depth_frame_base64: str, pose_frame_base64: str, frame_width: int, frame_height: int, prompt: str, negative_prompt: str = "", seed: int = -1) -> Dict[str, Any]:
    return {
